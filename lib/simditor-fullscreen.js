(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('rsimditor-fullscreen', ["jquery","r-simditor"], function (a0,b1) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("r-simditor"));
  } else {
    root['SimditorFullscreen'] = factory(root["jQuery"],root["Simditor"]);
  }
